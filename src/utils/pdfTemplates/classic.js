...
const drawMultilineBlock = (doc, lines, x, y, maxWidth, lineGap = 5.2) => {
    ...
    lines.forEach((line, index) => {
        ...
        doc.setTextColor(index === 0 ? 25 : 70, index === 0 ? 25 : 70, index === 0 ? 25 : 70);
...
const drawItemsTable = (doc, invoice, currency, startY) => {
    ...
    items.forEach((item, index) => {
        ...
        doc.setFillColor(index % 2 === 0 ? 255 : 249, index % 2 === 0 ? 255 : 249, index % 2 === 0 ? 255 : 249);
